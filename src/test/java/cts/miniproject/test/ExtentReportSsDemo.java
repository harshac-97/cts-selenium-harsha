...
//Progam for loading screenshot automatically by using program screenshot in utility
public class ExtentReportSsDemo {
	WebDriver driver;
	...
	Assert.assertTrue(driver.getTitle().contains("google123"));
